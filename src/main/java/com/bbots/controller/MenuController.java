...
public class MenuController {
    ...
    public void createProgram(@RequestBody Menu001 m) {
        authProcedureService.processAuthorization("101", "MENU-CRT", "MENU001", m);
    }
    ...
    public List<Menu004> getLinks(@PathVariable Integer roleCd, @PathVariable Integer menuCode, @PathVariable Integer subCode) {
    ...
    public void addParent(@RequestBody Menu002 m) {
        authProcedureService.processAuthorization("101", "MENU-CRT", "MENU002", m);
    }

    @PostMapping("/sub")
    public void addSub(@RequestBody Menu003 m) {
        authProcedureService.processAuthorization("101", "MENU-CRT", "MENU003", m);
    }

    @PostMapping("/link")
    public void addLink(@RequestBody Menu004 m) {
        authProcedureService.processAuthorization("101", "MENU-CRT", "MENU004", m);
    }
}
